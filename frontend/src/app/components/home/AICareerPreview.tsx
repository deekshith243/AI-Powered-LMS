...
import { FileText, ShieldCheck, Zap, ChevronRight } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {previewCards.map((card, i) => (
          <div 
            key={i}
            className="group bg-white rounded-3xl border border-gray-100 p-8 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 overflow-hidden relative"
          >
            {/* Background Accent */}
